...
- [ ] I searched [open issues](https://github.com/EdF2021/odysseus/issues) and [open PRs](https://github.com/EdF2021/odysseus/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Ithaka's existing visual language. Specifically:
