...
Imports MemoryManager and MemoryVectorStore from the Ithaka codebase.
"""
...
_OWNER_ENV_KEYS = ("ITHAKA_MCP_MEMORY_OWNER", "ITHAKA_MEMORY_OWNER")
_OWNER_SCOPE_ERROR = (
    "Error: Memory MCP owner is not configured for an owner-scoped memory store. "
    "Set ITHAKA_MCP_MEMORY_OWNER for this server or use the owner-aware native memory tool."
)
