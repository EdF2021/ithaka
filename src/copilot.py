...
COPILOT_USER_AGENT = os.environ.get(
    "ITHAKA_COPILOT_USER_AGENT", "Ithaka/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "ITHAKA_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "ITHAKA_COPILOT_EDITOR_VERSION", "Ithaka/1.0"
)
