...
Ithaka stands on the shoulders of a lot of open-source work. This file
...
Ithaka is a fork of [Odysseus](https://github.com/pewdiepie-archdaemon/odysseus),
an open-source self-hosted AI workspace. Credit and thanks to the original
Odysseus authors and contributors for the project this one builds on.
...
- **[Tongyi DeepResearch](https://github.com/Alibaba-NLP/DeepResearch)** by
  **Alibaba-NLP / Tongyi Lab** — the multi-step deep-research agent pipeline.
  Copyright © Alibaba-NLP / Tongyi Lab. **Apache-2.0.** Adapted for Ithaka's
...
and run alongside Ithaka on `docker compose up`. They are not modified —
just composed.
...
Ithaka talks to these over the network/API. They are **not** distributed
...
- **`caldav`** (Python lib) is **dual-licensed GPL-3.0-or-later OR Apache-2.0**.
  Ithaka uses it under **Apache-2.0**, which is permissive and MIT-compatible.
...
Most of Ithaka's code was written *with* AI models, not just by a human.
