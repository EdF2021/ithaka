"""scripts/_lib/cli.py — shared scaffolding for the `ithaka-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("ithaka-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/ithaka-foo`
...
VERSION = "0.1.0"  # bumped centrally; every ithaka-* CLI reports this
