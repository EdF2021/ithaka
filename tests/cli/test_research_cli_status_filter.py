"""`ithaka-research list --status complete` was returning nothing.
...
Part of #2122 (ithaka-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "ithaka-research"
    loader = importlib.machinery.SourceFileLoader("ithaka_research_cli", str(path))
