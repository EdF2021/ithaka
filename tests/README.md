...
```text
[order-report] working directory: /path/to/ithaka
...
[order-report] reproduce with: /path/to/ithaka/venv/bin/python /path/to/ithaka/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
