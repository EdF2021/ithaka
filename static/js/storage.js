...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'ithaka-model-expanded',
  MODEL_ENDPOINTS: 'ithaka-model-endpoints',
  MODEL_SELECTED: 'ithaka-selected-model',
  SORT_ORDER: 'ithaka-sessions-sort',
  CHAT_SEARCH_SCOPE: 'ithaka-search-scope',
  INCOGNITO: 'ithaka-incognito',
  RAG_ACTIVE: 'ithaka-rag-active',
  MCP_ACTIVE: 'ithaka-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'ithaka-density',
  UI_SCALE: 'ithaka-ui-scale',
  WORKSPACE: 'ithaka-workspace'
};
