...
const _rememberedDockKey = (id) => `ithaka-modal-remembered-dock-${id}`;
...
const _DOCK_STORAGE_KEY = 'ithaka.mobileDockState.v1';
...
const _AUTO_WIRE = {
  ...
  'meetings-panel':       { rail: 'rail-meetings',  sidebar: 'tool-meetings-btn' },
