...
const LS_KEY = 'ithaka-theme';
const CUSTOM_THEMES_KEY = 'ithaka-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Ithaka Logo',    group: 'Sidebar' },
...
const UI_SCALE_KEY = 'ithaka-ui-scale';
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'ithaka_' + (obj.name || 'theme') + '.json';
      a.click();
