...
INTERNAL_TOOL_TOKEN = os.environ.get("ITHAKA_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Ithaka-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Ithaka-Internal-Token), or
